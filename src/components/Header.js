      ...
      <div className="contenedor">
        <div className="grupo">
          ...
          <div className="redes">
            <div class="instagram">
              <a
                href="http://www.instagram.com/posadafincalahuerfana"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <div class="facebook">
              <a
                href="https://www.facebook.com/posadafincalahuerfana/?fref=ts"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <div class="twitter">
              <a
                href="http://twitter.com/#!/posada_huerfana/"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <div class="tripadvisor">
              <a
                href="https://www.tripadvisor.com.ve/Hotel_Review-g5982096-d4463002-Reviews-Posada_Finca_la_Huerfana-El_Cobre_Andean_Region.html"
                target="_blank"
                rel="noreferrer"
              >
                <img
        ...
        <nav className="menu nav">
          <ul>
            <li
              className={window.location.pathname === "/inicio" ? "active" : ""}
            >
              <Link to="/">Inicio</Link>
            </li>
            <li
              className={
                window.location.pathname === "/tarifas" ? "active" : ""
              }
            >
              <Link to="/tarifas">Tarifas, Servicios y Spa</Link>
            </li>
            <li
              className={window.location.pathname === "/aves" ? "active" : ""}
            >
            ...
            <li
              className={
                window.location.pathname === "/excursiones" ? "active" : ""
              }
            >
            ...
            <li
              className={
                window.location.pathname === "/sugerencias" ? "active" : ""
              }
            >
